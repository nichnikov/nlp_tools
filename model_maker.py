...
with open (os.path.join(models_rout, 'fast_answrs', "include_and_model.pickle"), "bw") as f:
    pickle.dump(model, f)
...
with open (os.path.join(models_rout, 'fast_answrs', "siamese_lstm_d2v_bss.pickle"), "bw") as f:
    pickle.dump(model, f)
